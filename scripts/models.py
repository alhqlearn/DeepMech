...
from model_utils import pack_atom_feats, unpack_atom_feats, pack_bond_feats, unpack_bond_feats, reactive_pooling, Global_Reactivity_Attention, GELU

#from my_model_utils import pack_atom_feats, unpack_atom_feats, pack_bond_feats, unpack_bond_feats, reactive_pooling, Global_Reactivity_Attention, GELU

class DeepMech(nn.Module):
    def __init__(self,
                 node_in_feats,
                 edge_in_feats,
                 node_out_feats,
        ...
        self.bond_att = Global_Reactivity_Attention(node_out_feats, attention_heads, attention_layers, 2)
    ...
    def forward(self, bg, adms, bonds_dict, node_feats, edge_feats):
        ...
        idxs_dict, rout_dict, bonds_feats, bonds = reactive_pooling(bg, atom_feats, bonds_dict, self.poolings, self.bondnets)
        ...
        #return template_v, template_r, rout_dict['virtual'], rout_dict['real'], idxs_dict['virtual'], idxs_dict['real'], ('unknown')
